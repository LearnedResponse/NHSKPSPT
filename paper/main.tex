...
\author[Adam Guetz]{Adam Guetz}
\address{Learned Response Labs}
\date{August 18, 2026}
...
produced by one system were independently rederived and hostilely audited by
...
mathematical verification; no human has.  Accordingly, the results are offered
as \emph{proof candidates pending external review}, and no claim in this note
should be treated as established until that review has occurred.
